...
const cases = {
    case1: {
        ...
        skins: [
            ...
            { name: 'AWP | Gungnir', rarity: 'covert', image: 'assets/images/awp_gungnir.png' },
            { name: 'M4A4 | The Emperor', rarity: 'classified', image: 'assets/images/m4a4_the_emperor.png' },
            { name: 'USP-S | Orion', rarity: 'restricted', image: 'assets/images/usps_orion.png' },
            { name: 'Glock-18 | Vogue', rarity: 'restricted', image: 'assets/images/glock18_vogue.png' },
            { name: 'Desert Eagle | Printstream', rarity: 'classified', image: 'assets/images/deagle_printstream.png' },
            { name: 'P90 | Asiimov', rarity: 'classified', image: 'assets/images/p90_asiimov.png' },
            { name: 'MAC-10 | Neon Rider', rarity: 'classified', image: 'assets/images/mac10_neon_rider.png' }
        ]
    },
    case2: {
        ...
        skins: [
            ...
            { name: 'P250 | See Ya Later', rarity: 'restricted', image: 'assets/images/p250_see_ya_later.png' },
            { name: 'FAMAS | Mecha Industries', rarity: 'mil-spec', image: 'assets/images/famas_mecha_industries.png' },
            { name: 'AK-47 | Gold Arabesque', rarity: 'covert', image: 'assets/images/ak47_gold_arabesque.png' },
            { name: 'M4A1-S | Printstream', rarity: 'covert', image: 'assets/images/m4a1s_printstream.png' },
            { name: 'Five-SeveN | Case Hardened', rarity: 'restricted', image: 'assets/images/five_seven_case_hardened.png' },
            { name: 'MP9 | Starlight Protector', rarity: 'restricted', image: 'assets/images/mp9_starlight_protector.png' },
            { name: 'Sawed-Off | The Kraken', rarity: 'mil-spec', image: 'assets/images/sawed_off_the_kraken.png' },
            { name: 'AUG | Akihabara Accept', rarity: 'covert', image: 'assets/images/aug_akihabara_accept.png' },
            { name: 'Galil AR | Cerberus', rarity: 'restricted', image: 'assets/images/galil_ar_cerberus.png' }
        ]
    }
};
