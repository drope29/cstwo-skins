...
function goBackToMain() {
    if (isRouletteSpinning) {
        ...
        if (currentWinningSkin) {
         ...
         // If we are in the result state (buttons shown), and user goes back,
         // we assume they want to KEEP the item since they didn't sell it.
         if (resultButtons.style.display !== 'none' && currentWinningSkin) {
             userInventory.push(currentWinningSkin);
             localStorage.setItem('userInventory', JSON.stringify(userInventory));
         }
    }
